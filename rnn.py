...
class RNN:
    def __init__(self, sequence_length, num_classes, vocab_size, embedding_size,
        ...
        with tf.device('/cpu:0'), tf.name_scope("text-embedding"):
            ...
            print("==================================================")
            print("Before:")
            print("self.W_text is:")
            print(self.W_text)
            print("self.input_text is:")
        ...
        with tf.name_scope("rnn"):
            ...
            self.h_outputs = self.last_relevant(self.all_outputs, text_length)
        ...
        with tf.name_scope("output"):
            ...
            print("==================================================")
            print("self.h_outputs is:")
            print(self.h_outputs)
            print("==================================================")
        ...
        with tf.name_scope("accuracy"):
            ...
            print(tf.shape(self.predictions))
            print("tf.argmax is:")
            print(tf.shape(tf.argmax(self.input_y, 1)))
            print("=======================================================================")
