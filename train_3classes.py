...
# tf.flags.DEFINE_integer("max_sentence_length", 49, "Max sentence length in train/test data (Default: 100)")
...
def make_dataset(X_data, Y_data, n_splits):
    for train_index, test_index in KFold(n_splits).split(X_data):
        x_train, x_dev = X_data[train_index], X_data[test_index]
        y_train, y_dev = Y_data[train_index], Y_data[test_index]
